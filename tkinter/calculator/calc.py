...
#adding image
minus_img = ImageTk.PhotoImage(Image.open("graphics/minus.png"))
plus_img = ImageTk.PhotoImage(Image.open("graphics/plus.png"))
equal_img = ImageTk.PhotoImage(Image.open("graphics/equal.png"))
